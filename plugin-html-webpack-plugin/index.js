...
class HtmlWebpackPlugin {
  ...
  apply (compiler) {
    ...
    // this.options.template: ./src/index.html
    // compiler.context: /Users/wujunfeng/codes/frontend/source/html-webpack-plugin
    this.options.template = this.getFullTemplatePath(this.options.template, compiler.context);
    // /Users/wujunfeng/codes/frontend/source/html-webpack-plugin/lib/loader.js
    // !/Users/wujunfeng/codes/frontend/source/html-webpack-plugin/src/index.html
    ...
    // path.resolve(filename): /Users/wujunfeng/codes/frontend/source/html-webpack-plugin/test.html
    // path.normalize(filename): test.html
    ...
    compiler.hooks.thisCompilation.tap('HtmlWebpackPlugin', (compilation) => {
      console.log('----------------this is thisCompilation----------------')
      ...
      // 将this.options.template 添加到子类的 this.templates 数组中
      
      // compilation.createChildCompiler: function, 创建实例
      ...
      compilation.hooks.additionalChunkAssets.tap('HtmlWebpackPlugin', () => {
        console.log('----------------this is additionalChunkAssets----------------')
    ...
    compiler.hooks.make.tapAsync('HtmlWebpackPlugin', (compilation, callback) => {
      ...
      // compilation.mainTemplate.hooks.assetPath: SyncWaterfallHook
      ...
      compilationPromise = childCompiler.compileTemplate(self.options.template, self.options.filename, compilation)
        ...
        .then(compilationResult => {
          ...
          // { hash: xxx, outputName: xxx, content: xxx }
      ...
      const entryPointPublicPaths = entryPointFiles
        .map(chunkFile => {
          ...
          return this.options.hash
            ? this.appendHash(entryPointPublicPath, compilationHash) // 在地址之后加hash,如：main.js?aa5e9c20347f6aad3dbf 
            : entryPointPublicPath;
        });

      entryPointPublicPaths.forEach((entryPointPublicPath) => {
        const extMatch = extensionRegexp.exec(entryPointPublicPath);
        // [ '.js', 'js', '', index: 4, input: 'main.js', groups: undefined ]
