...
class HtmlWebpackChildCompiler {
  ...
  compileTemplates (mainCompilation) {
    ...
    this.templates.forEach((template, index) => {
      ...
      // 以第一个为例
      // childCompiler.context: /Users/wujunfeng/codes/frontend/source/html-webpack-plugin
      // template: /Users/wujunfeng/codes/frontend/source/html-webpack-plugin/lib/loader.js
    ...
    this.compilationPromise = new Promise((resolve, reject) => {
      childCompiler.runAsChild((err, entries, childCompilation) => {
        // console.log(childCompilation.assets['__child-HtmlWebpackPlugin_0'].source())
        // 这里有值了
...
function extractHelperFilesFromCompilation (mainCompilation, childCompilation, filename, childEntryChunks) {
  ...
  // helperAssetNames 以一个入口为例：[ '__child-HtmlWebpackPlugin_0' ]
